...
class DataAPI: NSObject {
    ...
    func fetchList(_ url: String, params: Parameters? = nil, success: @escaping ((_ items:[JSON]?, _ total:Int?) -> Void!), failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - # V2
    //MARK: - System
    func endpoints(_ success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func authentication(_ username: String, password: String, remember: Bool, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func authenticationV2(_ username: String, password: String, remember: Bool, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL_V2() + "/authentication"
        self.authenticationCommon(url, username: username, password: password, remember: remember, success: success, failure: failure)
    }
    
    func getToken(_ success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func revokeAuthentication(_ success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/authentication"
    ...
    func revokeToken(_ success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/token"
    ...
    //MARK: - Search
    func search(_ query: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - Site
    func listSites(_ options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/sites"

        self.fetchList(url, params: options, success: success, failure: failure)
    }

    func listSitesByParent(siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createSite(_ site: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.siteAction(.post, siteID: nil, site: site, options: options, success: success, failure: failure)
    }

    func getSite(siteID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.siteAction(.get, siteID: siteID, site: nil, options: options, success: success, failure: failure)
    }

    func updateSite(siteID: String, site: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.siteAction(.put, siteID: siteID, site: site, options: options, success: success, failure: failure)
    }

    func deleteSite(siteID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.siteAction(.delete, siteID: siteID, site: nil, options: options, success: success, failure: failure)
    }

    func backupSite(siteID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - Blog
    func listBlogsForUser(_ userID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createBlog(_ blog: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.blogAction(.post, blogID: nil, blog: blog, options: options, success: success, failure: failure)
    }

    func getBlog(_ blogID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.blogAction(.get, blogID: blogID, blog: nil, options: options, success: success, failure: failure)
    }

    func updateBlog(_ blogID: String, blog: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.blogAction(.put, blogID: blogID, blog: blog, options: options, success: success, failure: failure)
    }

    func deleteBlog(_ blogID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.blogAction(.delete, blogID: blogID, blog: nil, options: options, success: success, failure: failure)
    }

    //MARK: - Entry
    func listEntries(siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createEntry(siteID: String, entry: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.entryAction(.post, siteID: siteID, entryID: nil, entry: entry, options: options, success: success, failure: failure)
    }

    func getEntry(siteID: String, entryID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.entryAction(.get, siteID: siteID, entryID: entryID, entry: nil, options: options, success: success, failure: failure)
    }

    func updateEntry(siteID: String, entryID: String, entry: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.entryAction(.put, siteID: siteID, entryID: entryID, entry: entry, options: options, success: success, failure: failure)
    }

    func deleteEntry(siteID: String, entryID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func listEntriesForCategory(siteID: String, categoryID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.listEntriesForObject("categories", siteID: siteID, objectID: categoryID, options: options, success: success, failure: failure)
    }

    func listEntriesForAsset(siteID: String, assetID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.listEntriesForObject("assets", siteID: siteID, objectID: assetID, options: options, success: success, failure: failure)
    }

    func listEntriesForSiteAndTag(siteID: String, tagID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.listEntriesForObject("tags", siteID: siteID, objectID: tagID, options: options, success: success, failure: failure)
    }

    func exportEntries(siteID: String, options: Parameters? = nil, success: ((String?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func publishEntries(_ entryIDs: [String], options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func importEntries(siteID: String, importData: Data? = nil, options: Parameters? = nil, progress: ((Double) -> Void)? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func previewEntry(siteID: String, entryID: String? = nil, entry: Parameters? = nil, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        var url = APIURL() + "/sites/\(siteID)/entries"
        if let id = entryID {
            url += "/\(id)/preview"
        } else {
    ...
    //MARK: - Page
    func listPages(siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createPage(siteID: String, page: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.pageAction(.post, siteID: siteID, pageID: nil, page: page, options: options, success: success, failure: failure)
    }

    func getPage(siteID: String, pageID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.pageAction(.get, siteID: siteID, pageID: pageID, page: nil, options: options, success: success, failure: failure)
    }

    func updatePage(siteID: String, pageID: String, page: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.pageAction(.put, siteID: siteID, pageID: pageID, page: page, options: options, success: success, failure: failure)
    }

    func deletePage(siteID: String, pageID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func listPagesForFolder(siteID: String, folderID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.listPagesForObject("folders", siteID: siteID, objectID: folderID, options: options, success: success, failure: failure)
    }

    func listPagesForAsset(siteID: String, assetID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.listPagesForObject("assets", siteID: siteID, objectID: assetID, options: options, success: success, failure: failure)
    }

    func listPagesForSiteAndTag(siteID: String, tagID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.listPagesForObject("tags", siteID: siteID, objectID: tagID, options: options, success: success, failure: failure)
    }

    func previewPage(siteID: String, pageID: String? = nil, entry: Parameters? = nil, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        var url = APIURL() + "/sites/\(siteID)/pages"
        if let id = pageID {
            url += "/\(id)/preview"
        } else {
    ...
    //MARK: - Category
    func listCategories(siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createCategory(siteID: String, category: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.categoryAction(.post, siteID: siteID, categoryID: nil, category: category, options: options, success: success, failure: failure)
    }

    func getCategory(siteID: String, categoryID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.categoryAction(.get, siteID: siteID, categoryID: categoryID, category: nil, options: options, success: success, failure: failure)
    }

    func updateCategory(siteID: String, categoryID: String, category: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func deleteCategory(siteID: String, categoryID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func listCategoriesForEntry(siteID: String, entryID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func listParentCategories(siteID: String, categoryID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func listSiblingCategories(siteID: String, categoryID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func listChildCategories(siteID: String, categoryID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func permutateCategories(siteID: String, categories: [Parameters]? = nil, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - Folder
    func listFolders(siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createFolder(siteID: String, folder: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.folderAction(.post, siteID: siteID, folderID: nil, folder: folder, options: options, success: success, failure: failure)
    }

    func getFolder(siteID: String, folderID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.folderAction(.get, siteID: siteID, folderID: folderID, folder: nil, options: options, success: success, failure: failure)
    }

    func updateFolder(siteID: String, folderID: String, folder: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.folderAction(.put, siteID: siteID, folderID: folderID, folder: folder, options: options, success: success, failure: failure)
    }

    func deleteFolder(siteID: String, folderID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func listParentFolders(siteID: String, folderID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.listFoldersForRelation("parents", siteID: siteID, folderID: folderID, options: options, success: success, failure: failure)
    }

    func listSiblingFolders(siteID: String, folderID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.listFoldersForRelation("siblings", siteID: siteID, folderID: folderID, options: options, success: success, failure: failure)
    }

    func listChildFolders(siteID: String, folderID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.listFoldersForRelation("children", siteID: siteID, folderID: folderID, options: options, success: success, failure: failure)
    }

    func permutateFolders(siteID: String, folders: [Parameters]? = nil, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - Tag
    func listTags(siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func getTag(siteID: String, tagID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.tagAction(.get, siteID: siteID, tagID: tagID, tag: nil, options: options, success: success, failure: failure)
    }

    func updateTag(siteID: String, tagID: String, tag: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.tagAction(.put, siteID: siteID, tagID: tagID, tag: tag, options: options, success: success, failure: failure)
    }

    func deleteTag(siteID: String, tagID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.tagAction(.delete, siteID: siteID, tagID: tagID, tag: nil, options: options, success: success, failure: failure)
    }

    //MARK: - User
    func listUsers(_ options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createUser(_ user: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.userAction(.post, userID: nil, user: user, options: options, success: success, failure: failure)
    }

    func getUser(_ userID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.userAction(.get, userID: userID, user: nil, options: options, success: success, failure: failure)
    }

    func updateUser(_ userID: String, user: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.userAction(.put, userID: userID, user: user, options: options, success: success, failure: failure)
    }

    func deleteUser(_ userID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.userAction(.delete, userID: userID, user: nil, options: options, success: success, failure: failure)
    }

    func unlockUser(_ userID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/users/\(userID)/unlock"

        self.post(url, params: options, success: success, failure: failure)
    }

    func recoverPasswordForUser(_ userID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/users/\(userID)/recover_password"

        self.post(url, params: options, success: success, failure: failure)
    }

    func recoverPassword(_ name: String, email: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - Asset
    func listAssets(siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/sites/\(siteID)/assets"

        self.fetchList(url, params: options, success: success, failure: failure)
    }
    
    func uploadAsset(_ assetData: Data, fileName: String, options: Parameters? = nil, progress: ((Double) -> Void)? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func uploadAssetForSite(_ siteID: String? = nil, assetData: Data, fileName: String, options: Parameters? = nil, progress: ((Double) -> Void)? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        var url = APIURL() + "/"
    ...
    func getAsset(siteID: String, assetID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.assetAction(.get, siteID: siteID, assetID: assetID, asset: nil, options: options, success: success, failure: failure)
    }

    func updateAsset(siteID: String, assetID: String, asset: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.assetAction(.put, siteID: siteID, assetID: assetID, asset: asset, options: options, success: success, failure: failure)
    }

    func deleteAsset(siteID: String, assetID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func listAssetsForEntry(siteID: String, entryID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.listAssetsForObject("entries", siteID: siteID, objectID: entryID, options: options, success: success, failure: failure)
    }

    func listAssetsForPage(siteID: String, pageID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.listAssetsForObject("pages", siteID: siteID, objectID: pageID, options: options, success: success, failure: failure)
    }

    func listAssetsForSiteAndTag(siteID: String, tagID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.listAssetsForObject("tags", siteID: siteID, objectID: tagID, options: options, success: success, failure: failure)
    }

    func getThumbnail(siteID: String, assetID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - Comment
    func listComments(siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func getComment(siteID: String, commentID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.commentAction(.get, siteID: siteID, commentID: commentID, comment: nil, options: options, success: success, failure: failure)
    }

    func updateComment(siteID: String, commentID: String, comment: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.commentAction(.put, siteID: siteID, commentID: commentID, comment: comment, options: options, success: success, failure: failure)
    }

    func deleteComment(siteID: String, commentID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func listCommentsForEntry(siteID: String, entryID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {

        self.listCommentsForObject("entries", siteID: siteID, objectID: entryID, options: options, success: success, failure: failure)
    }

    func listCommentsForPage(siteID: String, pageID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createCommentForEntry(siteID: String, entryID: String, comment: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createCommentForPage(siteID: String, pageID: String, comment: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createReplyCommentForEntry(siteID: String, entryID: String, commentID: String, reply: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createReplyCommentForPage(siteID: String, pageID: String, commentID: String, reply: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - Trackback
    func listTrackbacks(siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func getTrackback(siteID: String, trackbackID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func updateTrackback(siteID: String, trackbackID: String, trackback: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func deleteTrackback(siteID: String, trackbackID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func listTrackbackForEntry(siteID: String, entryID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {

        self.listTrackbackForObject("entries", siteID: siteID, objectID: entryID, options: options, success: success, failure: failure)
    }

    func listTrackbackForPage(siteID: String, pageID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {

        self.listTrackbackForObject("pages", siteID: siteID, objectID: pageID, options: options, success: success, failure: failure)
    }

    //MARK: - Field
    func listFields(siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createField(siteID: String, field: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.fieldAction(.post, siteID: siteID, fieldID: nil, field: field, options: options, success: success, failure: failure)
    }

    func getField(siteID: String, fieldID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.fieldAction(.get, siteID: siteID, fieldID: fieldID, field: nil, options: options, success: success, failure: failure)
    }

    func updateField(siteID: String, fieldID: String, field: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.fieldAction(.put, siteID: siteID, fieldID: fieldID, field: field, options: options, success: success, failure: failure)
    }

    func deleteField(siteID: String, fieldID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.fieldAction(.delete, siteID: siteID, fieldID: fieldID, field: nil, options: options, success: success, failure: failure)
    }

    //MARK: - Template
    func listTemplates(siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createTemplate(siteID: String, template: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.templateAction(.post, siteID: siteID, templateID: nil, template: template, options: options, success: success, failure: failure)
    }

    func getTemplate(siteID: String, templateID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.templateAction(.get, siteID: siteID, templateID: templateID, template: nil, options: options, success: success, failure: failure)
    }

    func updateTemplate(siteID: String, templateID: String, template: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func deleteTemplate(siteID: String, templateID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func publishTemplate(siteID: String, templateID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/sites/\(siteID)/templates/\(templateID)/publish"

        self.post(url, params: options, success: success, failure: failure)
    }

    func refreshTemplate(siteID: String, templateID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/sites/\(siteID)/templates/\(templateID)/refresh"

        self.post(url, params: options, success: success, failure: failure)
    }

    func refreshTemplateForSite(_ siteID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/sites/\(siteID)/refresh_templates"

        self.post(url, params: options, success: success, failure: failure)
    }

    func cloneTemplate(siteID: String, templateID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - TemplateMap
    func listTemplateMaps(siteID: String, templateID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createTemplateMap(siteID: String, templateID: String, templateMap: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func getTemplateMap(siteID: String, templateID: String, templateMapID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func updateTemplateMap(siteID: String, templateID: String, templateMapID: String, templateMap: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func deleteTemplateMap(siteID: String, templateID: String, templateMapID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - Widget
    func listWidgets(siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/sites/\(siteID)/widgets"

        self.fetchList(url, params: options, success: success, failure: failure)
    }

    func listWidgetsForWidgetset(siteID: String, widgetsetID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/sites/\(siteID)/widgetsets/\(widgetsetID)/widgets"

        self.fetchList(url, params: options, success: success, failure: failure)
    }

    func getWidgetForWidgetset(siteID: String, widgetSetID: String, widgetID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createWidget(siteID: String, widget: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.widgetAction(.post, siteID: siteID, widgetID: nil, widget: widget, options: options, success: success, failure: failure)
    }

    func getWidget(siteID: String, widgetID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.widgetAction(.get, siteID: siteID, widgetID: widgetID, widget: nil, options: options, success: success, failure: failure)
    }

    func updateWidget(siteID: String, widgetID: String, widget: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.widgetAction(.put, siteID: siteID, widgetID: widgetID, widget: widget, options: options, success: success, failure: failure)
    }

    func deleteWidget(siteID: String, widgetID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.widgetAction(.delete, siteID: siteID, widgetID: widgetID, widget: nil, options: options, success: success, failure: failure)
    }

    func refreshWidget(siteID: String, widgetID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/sites/\(siteID)/widgets/\(widgetID)/refresh"

        self.post(url, params: options, success: success, failure: failure)
    }

    func cloneWidget(siteID: String, widgetID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - WidgetSet
    func listWidgetSets(siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createWidgetSet(siteID: String, widgetSet: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func getWidgetSet(siteID: String, widgetSetID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func updateWidgetSet(siteID: String, widgetSetID: String, widgetSet: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func deleteWidgetSet(siteID: String, widgetSetID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - Theme
    func listThemes(_ options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/themes"

        self.fetchList(url, params: options, success: success, failure: failure)
    }

    func getTheme(_ themeID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/themes/\(themeID)"

        self.get(url, params: options, success: success, failure: failure)
    }

    func applyThemeToSite(siteID: String, themeID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/sites/\(siteID)/themes/\(themeID)/apply"

        self.post(url, params: options, success: success, failure: failure)
    }

    func uninstallTheme(_ themeID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/themes/\(themeID)"

        self.delete(url, params: options, success: success, failure: failure)
    }

    func exportSiteTheme(siteID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - Role
    func listRoles(_ options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createRole(_ role: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.roleAction(.post, roleID: nil, role: role, options: options, success: success, failure: failure)
    }

    func getRole(_ roleID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.roleAction(.get, roleID: roleID, role: nil, options: options, success: success, failure: failure)
    }

    func updateRole(_ roleID: String, role: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.roleAction(.put, roleID: roleID, role: role, options: options, success: success, failure: failure)
    }

    func deleteRole(_ roleID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.roleAction(.delete, roleID: roleID, role: nil, options: options, success: success, failure: failure)
    }

    //MARK: - Permission
    func listPermissions(_ options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func listPermissionsForUser(_ userID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {

        self.listPermissionsForObject("users", objectID: userID, options: options, success: success, failure: failure)
    }

    func listPermissionsForSite(_ siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {

        self.listPermissionsForObject("sites", objectID: siteID, options: options, success: success, failure: failure)
    }

    func listPermissionsForRole(_ roleID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {

        self.listPermissionsForObject("roles", objectID: roleID, options: options, success: success, failure: failure)
    }

    func grantPermissionToSite(_ siteID: String, userID: String, roleID: String, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func grantPermissionToUser(_ userID: String, siteID: String, roleID: String, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func revokePermissionToSite(_ siteID: String, userID: String, roleID: String, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func revokePermissionToUser(_ userID: String, siteID: String, roleID: String, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - Log
    func listLogs(siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createLog(siteID: String, log: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.logAction(.post, siteID: siteID, logID: nil, log: log, options: options, success: success, failure: failure)
    }

    func getLog(siteID: String, logID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.logAction(.get, siteID: siteID, logID: logID, log: nil, options: options, success: success, failure: failure)
    }

    func updateLog(siteID: String, logID: String, log: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.logAction(.put, siteID: siteID, logID: logID, log: log, options: options, success: success, failure: failure)
    }

    func deleteLog(siteID: String, logID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.logAction(.delete, siteID: siteID, logID: logID, log: nil, options: options, success: success, failure: failure)
    }

    func resetLogs(siteID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/sites/\(siteID)/logs"

        self.delete(url, params: options, success: success, failure: failure)
    }

    func exportLogs(siteID: String, options: Parameters? = nil, success: ((String?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - FormattedText
    func listFormattedTexts(siteID: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func createFormattedText(siteID: String, formattedText: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func getFormattedText(siteID: String, formattedTextID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func updateFormattedText(siteID: String, formattedTextID: String, formattedText: Parameters, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func deleteFormattedText(siteID: String, formattedTextID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - Stats
    func getStatsProvider(siteID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func pageviewsForPath(siteID: String, startDate: String, endDate: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func visitsForPath(siteID: String, startDate: String, endDate: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func pageviewsForDate(siteID: String, startDate: String, endDate: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func visitsForDate(siteID: String, startDate: String, endDate: String, options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    //MARK: - Plugin
    func listPlugins(_ options: Parameters? = nil, success: ((_ items:[JSON]?, _ total:Int?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        let url = APIURL() + "/plugins"

        self.fetchList(url, params: options, success: success, failure: failure)
    }

    func getPlugin(_ pluginID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
    ...
    func enablePlugin(_ pluginID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.togglePlugin(pluginID, enable: true, options: options, success: success, failure: failure)
    }

    func disablePlugin(_ pluginID: String, options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.togglePlugin(pluginID, enable: false, options: options, success: success, failure: failure)
    }

    func enableAllPlugin(_ options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.togglePlugin("*", enable: true, options: options, success: success, failure: failure)
    }

    func disableAllPlugin(_ options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
        self.togglePlugin("*", enable: false, options: options, success: success, failure: failure)
    }

    //MARK: - # V3
    //MARK: - Version
    func version(_ options: Parameters? = nil, success: ((JSON?) -> Void)!, failure: ((JSON?) -> Void)!)->Void {
